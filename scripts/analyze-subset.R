...
# --
setwd(paste('/data/enzedeng/software/ginkgo/uploads/', userID, sep=''))
maxPloidy = 6
...
normal2 = normal
#
GC = read.table(paste("/data/enzedeng/software/ginkgo/genomes/", genome, "/", pseudoautosomal, "/GC_", bm, sep=""), header=FALSE, sep="\t", as.is=TRUE)
#
bounds = read.table(paste("/data/enzedeng/software/ginkgo/genomes/", genome, "/", pseudoautosomal, "/bounds_", bm, sep=""), header=FALSE, sep="\t")
